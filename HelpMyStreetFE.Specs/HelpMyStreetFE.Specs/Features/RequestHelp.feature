...
Scenario Outline: Correct activities visible on generic Request Help form
	Then the volunteer's element .sm4:nth-child(<index>) .tiles__tile should have id task_<SupportActivityId>
	And the volunteer's element #task_<SupportActivityId> .tiles__tile__content__header should have text <Name>
	And the volunteer's element #task_<SupportActivityId> .tiles__tile__content__description should have text <Description>
