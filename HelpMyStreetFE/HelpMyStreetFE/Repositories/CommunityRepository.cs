...
namespace HelpMyStreetFE.Repositories
{
    public class CommunityRepository : ICommunityRepository
    {
        ...
        private Dictionary<string, CommunityModel> Communities = new Dictionary<string, CommunityModel>()
        {
            ...
            {"apex-pcn-bank-staff", new CommunityModel() {FriendlyName = "Apex PCN Bank Staff", Pin_Latitude = 53.196498, Pin_Longitude = -0.574294, Pin_VisibilityZoomLevel = 9, DisplayOnMap = true, BannerLocation = "/img/community/vacc/apex-pcn-bank-staff/banner.png", LinkURL = "/apexpcnbankstaff", GroupType = "Regional Group"} },
