export function intialiseCookieConsent() {
    $('body').ihavecookies({
        ...
        message: ' We use cookies to help make our website usable and to understand how visitors interact with us. More information can be found in our <a href="/privacy-policy" target="_blank">Privacy Policy</a>. <br /> You can change or disalbe cookies at any time by changing your browser settings.',
        expires: 365,
        delay: 2000,
        moreInfoLabel: '',
