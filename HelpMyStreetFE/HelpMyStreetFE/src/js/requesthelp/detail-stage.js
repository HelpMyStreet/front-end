...
var validateForm = function (validateRequestor) {
    ...
    $("form").on("submit", function (evt) {        
        ...
        const valid = validateFormData($(this), {
            ...
            "currentStep.OrganisationRequestor.OrganisationName": (v) => ((v.length >= 2 && !hasNumber(v))) || "Please enter an organisation name",
            ...
            "currentStep.OrganisationRequestor.MobileNumber": (v, d) => ((d["currentStep.Requestor.AlternatePhoneNumber"] !== "") || (v !== "")) || "Please enter a mobile number or an alternative phone number",
