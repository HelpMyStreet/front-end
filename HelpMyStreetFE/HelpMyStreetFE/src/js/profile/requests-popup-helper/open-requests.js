...
export function showVerifiedAcceptPopup(acceptBtn) {
    let popupMessage =
        `<p>Once you accept a task, you are responsible for working with the person who made the request (and / or the person who needs the help - if it was made on behalf of someone else) to get it done.</p>
            <p>The request will move from this page to your "<a href="/account/accepted-requests" target="_blank">My Accepted Requests</a>" page - from where you will be able to access more details about it - including contact details by clicking on "View more info".</p>
