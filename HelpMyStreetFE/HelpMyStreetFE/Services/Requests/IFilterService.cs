...
namespace HelpMyStreetFE.Services.Requests
{
    public interface IFilterService
    {
        ...
        Task<IEnumerable<RequestSummary>> SortAndFilterRequests(IEnumerable<RequestSummary> jobs, JobFilterRequest jobFilterRequest, int? userId, CancellationToken cancellationToken);
