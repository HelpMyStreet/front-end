...
namespace HelpMyStreetFE.Services
{
    public interface IRequestService
    {
        ...
        Task<BaseRequestHelpResponse<LogRequestResponse>> LogRequestAsync(RequestHelpRequestStageViewModel requestStage, RequestHelpDetailStageViewModel detailStage, int referringGroupID, string source, RequestHelpSource source2, int userId, HttpContext ctx);
        ...
        Task<RequestHelpViewModel> GetRequestHelpSteps(RequestHelpSource source2, int referringGroupID, string source);
    }
}