...
namespace HelpMyStreetFE.Services
{
    public interface IRequestService
    {
        ...
        Task<BaseRequestHelpResponse<LogRequestResponse>> LogRequestAsync(RequestHelpRequestStageViewModel requestStage, RequestHelpDetailStageViewModel detailStage, int referringGroupID, string source, RequestHelpFormVariant requestHelpFormVariant, int userId, HttpContext ctx);
