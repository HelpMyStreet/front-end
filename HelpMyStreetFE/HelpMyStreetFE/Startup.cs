...
namespace HelpMyStreetFE
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton(x => x.GetService<IMemDistCacheFactory<IEnumerable<int>>>().GetCache(new TimeSpan(2, 0, 0, 0), ResetTimeFactory.OnMinute));
            services.AddSingleton(x => x.GetService<IMemDistCacheFactory<RequestSummary>>().GetCache(new TimeSpan(1, 0, 0, 0), ResetTimeFactory.OnMinute));
