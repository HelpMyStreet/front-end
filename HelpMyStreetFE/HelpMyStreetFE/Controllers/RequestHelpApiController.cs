            ...
            try
            {
                ...
                switch (s)
                {
                    case JobStatuses.InProgress:
                        ...
                        return await _requestService.UpdateJobStatusToInProgressAsync(jobId, userId, targetUserId, cancellationToken);
                    case JobStatuses.Done:
                        return await _requestService.UpdateJobStatusToDoneAsync(jobId, userId, cancellationToken);
                    case JobStatuses.Cancelled:
                        return await _requestService.UpdateJobStatusToCancelledAsync(jobId, userId, cancellationToken);
                    case JobStatuses.Open:
                        return await _requestService.UpdateJobStatusToOpenAsync(jobId, userId, cancellationToken);
                    default:
